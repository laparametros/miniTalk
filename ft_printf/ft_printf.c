...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/30 18:51:21 by hkuyucu           #+#    #+#             */
/*   Updated: 2023/03/30 18:51:21 by hkuyucu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	specifierxup(char c, va_list lst, char *s, size_t strsize)
{
	if (c == 'x' || c == 'X')
	{
